...
describe("/dcm-admin/supporting-data/tc16-create-subset", function() {
    ...
    it("should create subset", function(done) {
    	browser
    		...
    		/*
            .execute('scrollTo(0, 3000)')
    		// Default to subitem 2
    		.elementByCss('#DefEntry1 > label.panel-checkbox-label > i').click()
            .execute('scrollTo(0, 3000)')
    		// Include subitem 2
    		.elementByCss('#IsEnable1 > label.panel-checkbox-label > i').click()
            .execute('scrollTo(0, 3000)')
    		// Include subitem 3
    		.elementByCss('#IsEnable2 > label.panel-checkbox-label > i').click()
    		*/
    ...
    /*
    it("should display subsets", function(done) {
    	browser
    		.frame()
    		.frame('sidebar')
    		.elementById('Tab_EnumManager_Enums_Main_Subsets_link').click()
    		.frame()
    		.frame('container')
    		.frame('cacheframe1')
    		.frame('subpage')
    		.frame('component_iframe')
    		.elementById('Grid_EnumManager_Enums_Main_SubsetsnodeRow0_0').text()
