...
describe("/user-manager/tc7-add-permission-to-checkin-contract-kit", function() {
    this.timeout(60000);
    var browser;
    ...
    it("should add permissions", function(done) {
        browser
            ...
            .elementById('Field_ElementSearch_Search_ElementName_Search_Value').type('ContractKitCheckIn')
            ...
            .should.eventually.become('ContractKitCheckIn'.toUpperCase())
            .notify(done);
    });
